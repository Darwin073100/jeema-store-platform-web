...
import { useBranchOfficeUpdateAddressModal } from '../hooks/useBranchOfficeUpdateAddressModal';

const BranchOfficeUpdateAddressModal = () => {
    const { branchOfficeModal, closeBranchOfficeModal } = useBranchOfficeUIStore();
    const { errors, handleSubmit, loading, onSubmit, register } = useBranchOfficeUpdateAddressModal();
    return (
        <TemplateModal isOpen={branchOfficeModal === 'editAddress'} onClose={closeBranchOfficeModal} title='Editar dirección'>
            <form onSubmit={handleSubmit(onSubmit)} className='p-4'>
                ...
                <Button type='submit' className='w-full mt-4' disabled={loading === 'editAddress'}>
                    {loading === 'editAddress' ? <Spinner /> : <IoSave />}
                    Guradar cambios
                </Button>
            </form>
        </TemplateModal>
...
export { BranchOfficeUpdateAddressModal };
