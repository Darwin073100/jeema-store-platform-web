...
import { useEmployeeUpdateAddressModal } from '../../hooks/hooks/useEmployeeUpdateAddressModal';

const EmployeeUpdateAddressModal = () => {
    const { employeeModal, closeEmployeeModal } = useEmployeeUIStore();
    const { errors, handleSubmit, loading, onSubmit, register } = useEmployeeUpdateAddressModal();
    return (
        <TemplateModal isOpen={employeeModal === 'editAddress'} onClose={closeEmployeeModal} title='Editar dirección'>
...
export { EmployeeUpdateAddressModal };
