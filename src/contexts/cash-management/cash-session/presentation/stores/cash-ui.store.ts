...
type ModalType  = 'registerCashRegister' | 'editCashRegister' | 'deactivateCashRegister' | 'openCashSession' | 'closeCashSession' | 'none' | 'cashTransaction' | 'cashClosedTicket' | 'cashClosedTicketList';
type LoadingType = 'registerCashRegister' | 'updateCashRegister' | 'activateCashRegister' | 'deactivateCashRegister' | 'openCashSession' | 'closeCashSession' | 'movementsCashSession' | 'none' | 'cashTransaction' | 'cashClosedTicket' | 'cashClosedTicketList';
