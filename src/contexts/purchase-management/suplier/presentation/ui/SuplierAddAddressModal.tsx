...
import { useSuplierAddAddressModal } from '../hooks/useCustomerAddAddressModal';

const SuplierAddAddressModal = () => {
    const { suplierModal, closeSuplierModal } = useSuplierUIStore();
    const { errors, handleSubmit, loading, onSubmit, register } = useSuplierAddAddressModal();
    return (
        <TemplateModal isOpen={suplierModal === 'addAddress'} onClose={closeSuplierModal} title='Registro de dirección'>
