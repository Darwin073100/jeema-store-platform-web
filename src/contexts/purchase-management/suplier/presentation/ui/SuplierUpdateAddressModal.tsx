...
import { useSuplierUpdateAddressModal } from '../hooks/useSuplierUpdateAddressModal';
import { useSuplierUIStore } from '../stores/suplier-ui.store';

const SuplierUpdateAddressModal = () => {
    const { suplierModal, closeSuplierModal } = useSuplierUIStore();
    const { errors, handleSubmit, loading, onSubmit, register } = useSuplierUpdateAddressModal();
    return (
        <TemplateModal isOpen={suplierModal === 'editAddress'} onClose={closeSuplierModal} title='Registro de dirección'>
...
export { SuplierUpdateAddressModal };
