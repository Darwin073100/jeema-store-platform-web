...
type ModalType  = 'editSuplier' | 'addAddress' | 'editAddress' | 'deleteSuplier' | 'none';
type LoadingType = 'editSuplier' | 'saveSuplier' | 'addAddress' | 'editAddress' | 'deleteSuplier' | 'none';
