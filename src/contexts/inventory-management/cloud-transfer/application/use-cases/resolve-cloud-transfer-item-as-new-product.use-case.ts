...
export class ResolveCloudTransferItemAsNewProductUseCase {
    ...
    async execute(dto: ResolveCloudTransferItemAsNewProductDto): Promise<CloudTransferItemEntity> {
        ...
        const inventoryEntity = InventoryEntity.reconstitute(
            ...
            true,
            new Date(),
            InventoryInternalBarCodeVO.create(null),
            InventorySalePriceOneVO.create(null),
            InventorySalePriceManyVO.create(null),
            InventorySaleQuantityManyVO.create(null),
            InventorySalePriceSpecialVO.create(null),
            InventoryMinStockBranchVO.create(null),
            InventoryMaxStockBranchVO.create(null),
            null,
            null,
            null,
            undefined,
