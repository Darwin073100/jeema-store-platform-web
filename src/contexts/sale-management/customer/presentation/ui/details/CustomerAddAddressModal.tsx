...
import { useCustomerAddAddressModal } from '../../hooks/useCustomerAddAddressModal';

const CustomerAddAddressModal = () => {
    const { customerModal, closeCustomerModal } = useCustomerUIStore();
    const { customerTypeOptions, errors, handleSubmit, loading, onSubmit, register } = useCustomerAddAddressModal();
    return (
        <TemplateModal isOpen={customerModal === 'addAddress'} onClose={closeCustomerModal} title='Registro de dirección'>
...
export { CustomerAddAddressModal };
