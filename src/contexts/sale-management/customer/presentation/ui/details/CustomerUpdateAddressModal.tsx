...
import { useCustomerUpdateAddressModal } from '../../hooks/useCustomerUpdateAddressModal';

const CustomerUpdateAddressModal = () => {
    const { customerModal, closeCustomerModal } = useCustomerUIStore();
    const { customerTypeOptions, errors, handleSubmit, loading, onSubmit, register } = useCustomerUpdateAddressModal();
    return (
        <TemplateModal isOpen={customerModal === 'editAddress'} onClose={closeCustomerModal} title='Registro de dirección'>
...
export { CustomerUpdateAddressModal };
