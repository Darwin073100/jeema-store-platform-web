...
const useCustomerForm = () => {
    const { floatMessageState, setFloatMessageState, loading, runLoading, stopLoading} = useCustomerUIStore();
    ...
    const onSubmit = async (data: FormData) => {
        ...
        const result = await registerCustomerAction(registerCustomerDTO);
        stopLoading();
