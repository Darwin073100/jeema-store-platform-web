...
const CustomerFormAddress = ({ errors, register }: Props) => {
    return (
        <div className="w-full">
            <h1 className="text-purple-600 font-semibold bg-purple-100 rounded-t-2xl p-2 text-lg uppercase text-center">Dirección del cliente</h1>
